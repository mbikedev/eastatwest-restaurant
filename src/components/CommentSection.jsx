          ...
          <motion.button
            ...
            style={{
              background: theme === 'dark'
                ...
                : 'linear-gradient(to right, #A8D5BA, #8BC5A8)',
              color: '#FFFFFF'
            }}
            className="px-8 py-4 rounded-xl font-bold text-lg transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none"
            whileHover={{ y: -2 }}
            whileTap={{ scale: 0.95 }}
          >
