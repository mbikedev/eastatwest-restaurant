              ...
              <div className="flex flex-col">
                ...
                <input
                  ...
                  className={`p-3 rounded-xl font-medium text-xs transition-all duration-300 focus:scale-105 ${
                    theme === "dark"
                      ? "text-[#F5F0E6] placeholder-gray-500 bg-[#2a2a2a] border-4 border-[#A8D5BA] focus:border-[#A8D5BA] focus:ring-2 focus:ring-[#A8D5BA]/50 shadow-[0_0_0_1px_#A8D5BA] outline outline-2 outline-[#A8D5BA]"
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
              ...
              <div className="flex flex-col">
                ...
                <select
                  ...
                  className={`p-3 rounded-xl font-medium text-xs transition-all duration-300 focus:scale-105 ${
                    theme === "dark"
                      ? "text-[#F5F0E6] bg-[#2a2a2a] border-4 border-[#A8D5BA] focus:border-[#A8D5BA] focus:ring-2 focus:ring-[#A8D5BA]/50 shadow-[0_0_0_1px_#A8D5BA] outline outline-2 outline-[#A8D5BA]"
