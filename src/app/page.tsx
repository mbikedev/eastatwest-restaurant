      ...
      <div className={`min-h-screen transition-colors duration-300 ${theme === 'dark' ? 'bg-[rgb(26,26,26)] text-[rgb(245,240,230)]' : 'bg-[rgb(245,240,230)] text-[rgb(26,26,26)]'
        ...
        <header className="relative h-screen w-full overflow-hidden" role="banner" aria-label="East @ West Restaurant Hero Section">
          ...
          <div className="absolute inset-0 flex items-center justify-center z-20">
            ...
            <div className="text-center px-4 sm:px-6 lg:px-8 max-w-6xl">
              ...
              <p
                className={`lcp-text text-sm xs:text-base sm:text-lg md:text-xl lg:text-2xl mb-6 sm:mb-8 md:mb-10 max-w-3xl mx-auto inline-block ${
                  theme === 'dark' ? 'text-white' : 'text-white'
                }`}
                style={{
                  font: 'italic 300 20px/32.5px Rozha One, serif',
        ...
        >
          ...
          <div className="max-w-7xl mx-auto relative z-10">
            ...
            <motion.section
              id="contact"
              className={`py-20 px-4 sm:px-6 lg:px-8 pb-32 relative ${theme === 'dark' ? 'bg-gray-900' : 'bg-gray-50'
                }`}
              initial="hidden"
              whileInView="visible"
              viewport={{ once: true }}
                    ...
                    <div className="space-y-6">
                      ...
                      <div className="flex items-center">
                        ...
                        <a
                          ...
                          className={`w-12 h-12 rounded-full flex items-center justify-center mr-4 cursor-pointer hover:scale-110 transition-transform duration-300 ${theme === 'dark' ? 'bg-gray-500 hover:bg-green-500 active:bg-green-500' : 'bg-gray-900 hover:bg-green-600 active:bg-green-600'
                            }`}
                        >
                          {/* Phone Icon SVG */}
                      ...
                      <div className="flex items-start">
                        ...
                        <a
                          ...
                          className={`w-12 h-12 rounded-full flex items-center justify-center mr-4 flex-shrink-0 cursor-pointer hover:scale-110 transition-transform duration-300 ${theme === 'dark' ? 'bg-gray-500 hover:bg-green-500 active:bg-green-500' : 'bg-gray-900 hover:bg-green-600 active:bg-green-600'
                            }`}
                        >
                          {/* Email Icon SVG */}
                          <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      ...
                      <div className="flex items-start">
                        ...
                        <a
                          ...
                          className={`w-12 h-12 rounded-full flex items-center justify-center mr-4 mt-1 cursor-pointer hover:scale-110 transition-transform duration-300 ${theme === 'dark' ? 'bg-gray-500 hover:bg-green-500 active:bg-green-500' : 'bg-gray-900 hover:bg-green-600 active:bg-green-600'
                            }`}
                        >
                          {/* Address Icon SVG */}
                          <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
